...
- [Project Curator: Technical Design Document](#project-curator-technical-design-document)
  ...
  - [3. The Service API Contract](#3-the-service-api-contract)
    - [3.1. API Specification \& Transport](#31-api-specification--transport)
    - [3.2. Authentication \& Authorization](#32-authentication--authorization)
    - [3.3. Error Handling \& Idempotency](#33-error-handling--idempotency)
  - [4. The Metadata Store \& Data Model](#4-the-metadata-store--data-model)
    - [4.1. Database Consistency Strategy](#41-database-consistency-strategy)
    - [4.2. Final SQL Schema](#42-final-sql-schema)
  - [5. Plugin System \& Security Sandbox](#5-plugin-system--security-sandbox)
    - [5.1. Runtime Environment](#51-runtime-environment)
    - [5.2. Permissions, Manifest \& Signing](#52-permissions-manifest--signing)
  - [6. Backup, Restore \& Disaster Recovery](#6-backup-restore--disaster-recovery)
    - [6.1. Backup Format](#61-backup-format)
    - [6.2. Encryption](#62-encryption)
    - [6.3. Verification \& Restore](#63-verification--restore)
  - [7. Detailed Workflows](#7-detailed-workflows)
    - [7.1. Search Architecture](#71-search-architecture)
    - [7.2. Concept Training Pipeline](#72-concept-training-pipeline)
  - [8. Observability \& Health Monitoring](#8-observability--health-monitoring)
  - [9. Packaging \& Release Management](#9-packaging--release-management)
  - [10. Prioritized Implementation Roadmap](#10-prioritized-implementation-roadmap)
    - [Milestone 1: MVP (Core Engine \& Safety)](#milestone-1-mvp-core-engine--safety)
    - [Milestone 2: Production Readiness (v1.0)](#milestone-2-production-readiness-v10)
    - [Milestone 3: Scale \& Polish (v2.0)](#milestone-3-scale--polish-v20)
...
- **Restore:** The restore process validates checksums and signatures before overwriting any data. It will flag if AI model versions have changed since the backup ws made, suggesting a re-indexing.
