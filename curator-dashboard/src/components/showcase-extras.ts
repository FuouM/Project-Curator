...
export const metas: ComponentMeta[] = [
  {
    ...
    description:
      "Complete color reference organized by component. Use this to find and update any color in the stylesheet.",
    variants: [
      {
        name: "Theme Variables (CSS Custom Properties)",
        render: () => html`
          <div
            style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 8px; width: 100%;"
          >
            ${[
      ...
      },
      {
        ...
        render: () => html`
          <div
            style="display: grid; grid-template-columns: repeat(auto-fill, minmax(160px, 1fr)); gap: 8px; width: 100%;"
          >
            ${[
      ...
      },
      {
        ...
        render: () => html`
          <div
            style="display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: 8px; width: 100%;"
          >
            ${[
...

  {
    ...
    variants: [
      ...
      },
      {
        ...
        render: () => html`
          <div
            style="display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 12px; width: 100%;"
          >
...

  {
    ...
    description:
      "Tag indicators styled uniquely by categories (user, character, series copyright, system meta, etc.).",
    variants: [
      {
        name: "Status Badges",
        render: () => html`
          <div style="display: flex; flex-wrap: wrap; gap: 8px; align-items: center;">
            <span class="vector-badge badge-ready" style="position: static;"
              >badge-ready (Ready)</span
            >
            <span class="vector-badge badge-pending" style="position: static;"
              >badge-pending (Pending)</span
            >
          </div>
        `,
      },
      {
        ...
        render: () => html`
          <div style="display: flex; flex-direction: column; gap: 8px;">
            ${[
              {
                label: "User-added tag (with remove button):",
                tag: { tag: "user-tag", category: "user" },
                opt: { isDeletable: true },
              },
              {
                label: "Character identifier:",
                tag: { tag: "character_name", category: "character" },
              },
              {
                label: "Copyright franchise / series:",
                tag: { tag: "series_title", category: "copyright" },
              },
...

  {
    ...
    description:
      "Category badges used on concept cards to indicate type (character, copyright, general, artist).",
    variants: [
      {
...

  {
    ...
    description:
      "Layout rows for top-level menus, contextual tool buttons, and bottom status strips.",
    variants: [
      {
        ...
        render: () => html`
          <nav
            class="menu-strip"
            style="position: static; border: 1px solid var(--sys-menu-border); width: 100%;"
          >
      ...
      },
      {
        ...
        render: () => html`
          <footer
            class="status-strip"
            style="position: static; border: 1px solid var(--sys-border-dark); width: 100%;"
          >
...

  {
    ...
    description:
      "Skeleton placeholders, progress bars, spinners, and indeterminate loaders for async states.",
    variants: [
      {
        ...
        render: () => html`
          <div style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
            ...
            <div style="font-size: 11px; font-weight: 600; color: #555; margin-top: 8px;">
              Card Skeleton
            </div>
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px;">
              <div
                class="skeleton-card skeleton-pulse"
                style="height: 160px; border-radius: 4px;"
              ></div>
              <div
                class="skeleton-card skeleton-pulse"
                style="height: 160px; border-radius: 4px;"
        ...
        render: () => html`
          <div style="display: flex; flex-direction: column; gap: 14px; width: 100%;">
            <div>
              ...
              >
                <div
                  style="width: 0%; height: 100%; background-color: #3b82f6; transition: width 0.3s ease;"
                ></div>
              </div>
            </div>
            <div>
              ...
              >
                <div
                  style="width: 35%; height: 100%; background-color: #3b82f6; transition: width 0.3s ease;"
                ></div>
              </div>
            </div>
            <div>
              ...
              >
                <div
                  style="width: 72%; height: 100%; background-color: #3b82f6; transition: width 0.3s ease;"
                ></div>
              </div>
            </div>
            <div>
              <div style="font-size: 11px; font-weight: 600; color: #555; margin-bottom: 4px;">
                Determinate — 100% (Complete)
              </div>
              <div
                style="width: 100%; height: 8px; background-color: #e5e7eb; border-radius: 4px; overflow: hidden;"
              >
                <div
                  style="width: 100%; height: 100%; background-color: #10b981; transition: width 0.3s ease;"
                ></div>
              </div>
            </div>
            <div>
              ...
              <div
                style="width: 100%; height: 8px; background-color: #e5e7eb; border-radius: 4px; overflow: hidden; position: relative;"
              >
                <div
                  class="progress-indeterminate"
                  style="position: absolute; top: 0; left: 0; width: 40%; height: 100%; background-color: #3b82f6; border-radius: 4px;"
                ></div>
              </div>
            </div>
            <div>
              ...
              <div
                style="width: 100%; height: 16px; background-color: #e5e7eb; border-radius: 4px; overflow: hidden; border: 1px solid #d1d5db;"
              >
                <div
                  style="width: 60%; height: 100%; background-color: var(--sys-primary, #0078d4); transition: width 0.3s ease;"
                ></div>
              </div>
            </div>
            <div>
              <div style="font-size: 11px; font-weight: 600; color: #555; margin-bottom: 4px;">
                Segmented Progress (Preprocessing + Indexing)
              </div>
              <div
                style="width: 100%; height: 10px; background-color: #e5e7eb; border-radius: 4px; overflow: hidden; display: flex;"
              >
...

  {
    name: "GroupBox Panel",
    description:
      "Native WinForms fieldset-style containers with optional collapsible body sections.",
    variants: [
      {
          ...
          <div style="display: flex; flex-direction: column; gap: 16px; width: 100%;">
            <div class="group-box">
              <div class="group-box-title">
                <i class="bi bi-folder2-open"></i> Standard GroupBox
              </div>
              <div class="group-box-body">
                <p style="font-size: 11px; color: #555;">
                  This is a standard group-box container with a fixed title bar. Content renders
                  below the title.
                </p>
            ...
            <div class="group-box collapsed">
              <div class="group-box-title">
                ...
                <button type="button" class="group-box-collapse-btn">
                  <i class="bi bi-chevron-down"></i>
                </button>
              </div>
              <div class="group-box-body" style="display: none;">
                <p style="font-size: 11px; color: #555;">
                  This content is hidden when collapsed. Click the chevron to toggle.
                </p>
              </div>
            </div>
          </div>
...

  {
    name: "Modal Dialog",
    description:
      "Standard WinForms-style modal dialog overlay with header, body, and footer action bar.",
    variants: [
      {
        name: "Dialog Structure",
        render: () => html`
          <div
            style="width: 100%; max-width: 420px; border: 1px solid #7a7a7a; box-shadow: 0 4px 16px rgba(0, 0, 0, 0.2); background-color: var(--sys-control-bg);"
          >
            ...
            <div class="modal-body">
              <p style="font-size: 12px; color: #333;">
                This is a modal dialog body. It contains the main content area for forms, messages,
                or details.
              </p>
              <div class="form-group">
      ...
      },
      {
        ...
        render: () => html`
          <div style="display: flex; gap: 12px; align-items: center;">
            <div
              style="background-color: #0078d7; color: #fff; padding: 4px 10px; display: flex; align-items: center; gap: 8px;"
            >
              <span style="font-weight: bold; font-size: 12px;">Title Bar</span>
              <div
                class="modal-close"
                style="margin: -4px -10px; padding: 4px 10px; position: static;"
              >
                &times;
              </div>
            </div>
...

  {
    name: "Alert Dialog",
    description:
      "Centered modal alert with a copy button for the full message, used to surface errors and notices.",
    variants: [
      {
        ...
        render: () => html`
          <div style="display: flex; flex-wrap: wrap; gap: 8px;">
            <button
              ...
              data-action="show-alert-demo"
              data-alert-kind="error"
            >
              <i class="bi bi-exclamation-octagon-fill"></i> Trigger Error Alert
            </button>
            <button
              type="button"
              class="win-button"
            ...
            >
              <i class="bi bi-exclamation-triangle-fill"></i> Trigger Warning Alert
            </button>
            <button
              type="button"
              class="win-button"
            ...
            >
              <i class="bi bi-info-circle-fill"></i> Trigger Info Alert
            </button>
            <button
              type="button"
              class="win-button"
              data-action="show-alert-demo"
              data-alert-kind="success"
            >
              <i class="bi bi-check-circle-fill"></i> Trigger Success Alert
            </button>
          </div>
        `,
      },
...

  {
    name: "Image Viewer",
    description:
      "Full-screen lightbox overlay for viewing images at full resolution with navigation controls.",
    variants: [
      {
        name: "Viewer Structure",
        render: () => html`
          <div
            style="width: 100%; display: flex; flex-direction: column; border: 1px solid #555; background-color: #1e1e1e;"
          >
            <div class="image-viewer-header">
              <span class="image-viewer-title"
                ><i class="bi bi-image"></i> sample_image.png — C:\\Users\\demo\\Pictures\\</span
              >
            ...
            <div class="image-viewer-content" style="height: 200px;">
              <div class="image-viewer-body" style="background-color: #2d2d2d;">
                <div style="color: #888; font-size: 12px; text-align: center;">
                  <i
                    class="bi bi-image"
                    style="font-size: 48px; display: block; margin-bottom: 8px;"
                  ></i>
                  Image preview area
                </div>
              </div>
              <div class="image-viewer-info-panel open" style="height: 200px;">
                <div class="image-viewer-info-header">
                  <span class="image-viewer-title"
                    ><i class="bi bi-info-circle"></i> Image Details</span
                  >
        ...
        render: () => html`
          <div style="display: flex; gap: 8px; align-items: center;">
            ...
            <div
              ...
              style="background-color: #333; border: 1px solid #555; padding: 2px 8px;"
            >
              &times;
            </div>
          </div>
...

  {
    name: "Featured Card",
    description:
      "Feature of the Day highlight card with large preview, overlay badge, and action buttons.",
    variants: [
      {
        ...
        render: () => html`
          <div class="featured-layout" style="width: 100%;">
            <div class="image-card featured-card">
              ...
              <div
                class="image-preview featured-preview"
                style="height: 200px; background-color: #f7f7f7; position: relative;"
              >
                ...
                <div class="featured-badge-overlay">
                  <i class="bi bi-stars"></i> Feature of the Day
                </div>
                <div
                  class="copy-btn"
                  style="position: absolute; bottom: 1px; left: 1px; opacity: 0;"
                >
                  <i class="bi bi-clipboard"></i>
                </div>
              </div>
              <div style="padding: 6px 2px; display: flex; gap: 6px;">
                <button class="win-button" style="font-size: 11px; flex: 1;">
            ...
            <div class="featured-details">
              ...
              <div class="image-path-row">
                <div class="image-path" title="C:\\Users\\demo\\Pictures\\sample_image.png">
                  C:\\...\\sample_image.png
                </div>
                <button
        ...
        render: () => html`
          <div class="tagstats-category">
            <div class="tagstats-category-header">
              <span class="tagstats-category-title" style="color: #0078d7;"
                >Meta Tags <span class="tagstats-count">(48)</span></span
              >
              <button class="win-button tagstats-chart-toggle" style="font-size: 10px;">
...

  {
    name: "Image Path Row",
    description:
      "Image file path display with copy-to-clipboard, open folder, and path masking controls.",
    variants: [
      {
        ...
        render: () => html`
          <div style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
            <div
              style="padding: 8px; background: var(--sys-window-bg); border: 1px solid var(--sys-border-dark);"
            >
              <div class="image-path-row">
                <div
                  class="image-path"
                  title="C:\\Users\\demo\\Pictures\\Artists\\sample_image.png"
                ...
                <button
                  class="win-button image-open-folder-btn"
                  style="font-size: 10px; padding: 1px 6px; white-space: nowrap;"
                >
            ...
            >
              <div class="image-path-row">
                <div
                  class="image-path"
                  title="D:\\Gallery\\2026\\vacation_photo.jpg"
                  style="cursor: pointer;"
                >
                  D:\\...\\vacation_photo.jpg
                </div>
                <button
                  class="win-button image-open-folder-btn"
                  style="font-size: 10px; padding: 1px 6px; white-space: nowrap;"
        ...
        render: () => html`
          <div style="display: flex; gap: 16px; align-items: center;">
            <div style="position: relative; display: inline-flex;">
              <div
                class="copy-btn"
                style="position: static; opacity: 1; background: var(--sys-window-bg); border: 1px solid #dcdcdc;"
              >
                <i class="bi bi-clipboard"></i>
              </div>
...

  {
    name: "OCR Text Block",
    description:
      "Expandable monospace text block for displaying OCR-extracted text from images. Click to toggle between collapsed (5 lines) and expanded state; hover the file-earmark icon to reveal the copy button that copies the OCR text.",
    variants: [
      {
          ...
          <div style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
            ...
            <div class="ocr-block" style="position: static;">
              ...
              <span class="ocr-block-text"
                >This is sample OCR extracted text from an image. It can contain multiple lines of
                text that were recognized by the optical character recognition engine. The text is
                displayed in a monospace font and is truncated when collapsed.</span
              >
            </div>
            ...
            <div class="ocr-block expanded" style="position: static;">
              ...
              <span class="ocr-block-text"
                >This is sample OCR extracted text from an image. It can contain multiple lines of
                text that were recognized by the optical character recognition engine. The text is
                displayed in a monospace font and shows all content when expanded. Click the block
                to toggle between states.</span
              >
            </div>
          </div>
        `,
...

  {
    ...
    description:
      "Typeahead suggestion dropdown for input fields. Shows matching items with count badges and supports keyboard navigation.",
    variants: [
      {
        name: "Dropdown with Suggestions",
        render: () => html`
          <div
            style="display: flex; flex-direction: column; gap: 12px; width: 100%; max-width: 300px;"
          >
            <div style="position: relative;">
              <input class="input-field" style="width: 100%;" value="cha" readonly />
              <div
                class="autocomplete-dropdown"
                style="position: relative; top: 0; width: 100%; box-shadow: none; border: 1px solid var(--sys-border-dark);"
              >
...

  {
    name: "Range Slider",
    description:
      "Labeled range slider for numeric settings like similarity thresholds. Displays current value with accent-colored track.",
    variants: [
      {
      ...
      },
      {
        ...
        render: () => html`
          <div
            style="display: flex; flex-direction: column; gap: 16px; width: 100%; max-width: 320px;"
          >
            <div class="concept-threshold-box">
              <div class="concept-threshold-header">
...

  {
    name: "Identity Tags",
    description:
      "Character identity tag pills with reddish-pink styling and person icon, used on image cards to show detected characters.",
    variants: [
      {
        ...
        render: () => html`
          <div style="display: flex; flex-direction: column; gap: 10px;">
            <div style="font-size: 11px; font-weight: 600; color: #555;">
              Identity List (with border separator)
            </div>
            <div class="identity-list">
              <span class="tag-pill tag-identity"
                ><i class="bi bi-person-fill"></i> Character A</span
              >
              <span class="tag-pill tag-identity"
                ><i class="bi bi-person-fill"></i> Character B</span
              >
              <span class="tag-pill tag-identity"
                ><i class="bi bi-person-fill"></i> Character C</span
              >
            </div>
            <div style="font-size: 11px; font-weight: 600; color: #555;">Single Identity Tag</div>
            <div style="display: flex; gap: 6px;">
              <span class="tag-pill tag-identity"
                ><i class="bi bi-person-fill"></i> Solo Character</span
              >
            </div>
          </div>
        `,
...

  {
    ...
    description:
      "Action buttons that appear on hover over image cards: star/favorite, copy to clipboard, and info details.",
    variants: [
      {
      ...
      },
      {
        ...
        render: () => html`
          <div style="display: flex; gap: 16px; align-items: center;">
            ...
            <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
              <div class="copy-btn copied" style="position: static; opacity: 1;">
...

  {
    name: "Data Tables",
    description:
      "Styled data tables for displaying structured information with alternating rows, hover states, and status indicators.",
    variants: [
      {
        name: "Folders Table",
        render: () => html`
            ...
            <tbody>
              <tr class="folders-row">
                ...
                <td style="text-align: right;">
                  <span style="color: #2e7d32;">1,100</span> / 1,234
                </td>
                <td style="text-align: center;">
                  <button
                    class="win-button folders-open-btn"
              ...
              <tr class="folders-row">
                <td style="text-align: center;">
                  <i class="bi bi-exclamation-circle" style="color: #e8912d;"></i>
                </td>
              ...
              <tr class="folders-row missing">
                <td style="text-align: center;">
                  <i class="bi bi-exclamation-triangle" style="color: #e8912d;"></i>
                </td>
                ...
                <td style="text-align: center;">
                  ...
                  <button class="win-button danger" style="font-size: 11px; padding: 2px 8px;">
          ...
          <table class="curator-table" style="width: 100%;">
            ...
            <tbody>
              <tr>
                ...
                <td>5 tags</td>
                <td>
                  <span class="vector-badge badge-ready" style="position: static;">ready</span>
                </td>
              </tr>
              <tr>
                <td>1002</td>
                ...
                <td>3 tags</td>
                <td>
                  <span class="vector-badge badge-pending" style="position: static;">pending</span>
                </td>
              </tr>
              <tr>
                <td>1003</td>
...

  {
    name: "Log Viewer",
    description:
      "Dark monospace log display with color-coded log levels, timestamps, and collapsible JSON blocks.",
    variants: [
      {
        name: "Log Line Variants",
        render: () => html`
          <div
            style="background-color: #1e1e1e; padding: 10px; font-family: 'Consolas', 'Courier New', monospace; font-size: 11px; line-height: 1.6; width: 100%; border: 1px solid #333;"
          >
            <div>
              <span style="color: #666;">[2026-08-03 10:15:32]</span>
              <span style="color: #6a9955;">INFO</span>
              <span style="color: #cccccc;">Service started successfully</span>
            </div>
            <div>
              <span style="color: #666;">[2026-08-03 10:15:33]</span>
              <span style="color: #6a9955;">INFO</span>
              <span style="color: #cccccc;">Loaded CLIP model: ViT-B/32</span>
            </div>
            <div>
              <span style="color: #666;">[2026-08-03 10:15:34]</span>
              <span style="color: #dcdcaa;">WARN</span>
              <span style="color: #cccccc;">Thumbnail cache misses: 23</span>
            </div>
            <div>
              <span style="color: #666;">[2026-08-03 10:15:35]</span>
              <span style="color: #f44747;">ERROR</span>
              <span style="color: #cccccc;">Failed to index image: disk not accessible</span>
            </div>
            <div>
              <span style="color: #666;">[2026-08-03 10:15:36]</span>
              <span style="color: #569cd6;">DEBUG</span>
              <span style="color: #cccccc;">Vector search completed in 12ms</span>
            </div>
          </div>
        `,
      },
      {
        ...
        render: () => html`
          <div style="display: flex; gap: 0; width: 100%; max-width: 300px;">
            <button class="win-button log-tab active" style="border-radius: 2px 0 0 2px;">
              Dashboard
            </button>
...

  {
    ...
    description:
      "Bulk action toolbar shown when image card selection mode is active. Provides Select All, Clear, and action buttons.",
    variants: [
      {
        name: "Selection Bar",
        render: () => html`
          <div
            style="display: flex; align-items: center; gap: 12px; padding: 8px 12px; background-color: var(--sys-highlight-bg); color: var(--sys-highlight-text); width: 100%; border-radius: 2px;"
          >
            <span style="font-size: 12px; font-weight: 600;">12 selected</span>
            <div style="flex: 1;"></div>
            <button
              class="win-button"
              style="font-size: 11px; background: rgba(255,255,255,0.15); color: #fff; border-color: rgba(255,255,255,0.3);"
            >
              Select All
            </button>
            <button
            ...
            <button
              class="win-button"
              style="font-size: 11px; background: rgba(255,255,255,0.25); color: #fff; border-color: rgba(255,255,255,0.4);"
            >
...

  {
    ...
    description:
      "Warning badge overlay shown on image cards when the source file is no longer found on disk.",
    variants: [
      {
        name: "Missing Badge",
        render: () => html`
          <div
            style="position: relative; width: 200px; height: 140px; background: #f7f7f7; border: 1px solid var(--sys-border-dark); display: flex; align-items: center; justify-content: center;"
          >
...

  {
    ...
    description:
      "Labeled key-value row used inside concept cards for displaying metadata like sample counts and dates.",
    variants: [
      {
        name: "Info Row Examples",
        render: () => html`
          <div
            style="display: flex; flex-direction: column; gap: 8px; width: 100%; max-width: 320px;"
          >
...

  {
    ...
    description:
      "Overflow indicator pill showing remaining tag count when a tag list is truncated.",
    variants: [
      {
        name: "Overflow Pill",
        render: () => html`
    ...
    variants: [
      {
        ...
        render: () => html`
          <div style="display: flex; gap: 8px; align-items: center;">
            <div
              class="crop-placeholder-slot"
              style="width: 64px; height: 64px; border: 1px dashed var(--sys-border-dark); background: var(--sys-window-bg);"
            ></div>
            <div
              class="crop-placeholder-slot"
              style="width: 64px; height: 64px; border: 1px dashed var(--sys-border-dark); background: var(--sys-window-bg);"
        ...
        render: () => html`
          <div style="display: flex; gap: 12px; align-items: center;">
            <button
              ...
              style="position: static; width: 24px; height: 24px; font-size: 12px;"
            >
              <i class="bi bi-check-lg"></i>
            </button>
...

  {
    name: "Tool Strip",
    description:
      "Horizontal toolbar container with compact buttons and vertical separators for action groups.",
    variants: [
      {
