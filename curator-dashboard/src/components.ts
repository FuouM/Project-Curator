...
// Single unified registry for the component dev view.
// Each key maps to a display name, description, and optional variants.
...
export const SHOWCASE_COMPONENTS: Record<string, { name: string; description: string; variants?: ComponentVariant[] }> = {

  // ── Core Render Function Showcases ────────────────────────────────
